...
/**
 * read_elf_header - a function that read elf_header.
 * @fd : file descriptor.
...
/**
 * validate_elf_file - valitae elf file.
...
/**
 * display_elf_header - a function that print elf ageader.
 * @header: pointre to the header
*/
